...
require_once '../controlador/editar_perfil_controlador.php';
?>
...
<section class="registro container py-5">
    ...
    <form id="editProfileForm" action="../controlador/editar_perfil_controlador.php" method="post" class="needs-validation" novalidate>
        <div class="row">
            <div class="col-md-6">
